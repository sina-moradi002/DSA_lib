...
class MyTestCase(unittest.TestCase):
    ...
    def test_right_child(self):
        ...
        self.assertRaises(IndexError, self.heap.right_child, 1)
        self.heap.insert(7)
        self.assertEqual(self.heap.right_child(0), 2)
        self.assertEqual(self.heap.right_child(1), 4)
        self.assertRaises(IndexError, self.heap.right_child, 2)
        self.heap.insert(9)
        self.assertEqual(self.heap.right_child(0), 2)
        self.assertEqual(self.heap.right_child(1), 4)
    ...
    def test_left_child(self):
        ...
        self.assertRaises(IndexError, self.heap.left_child, 1)
        self.heap.insert(7)
        self.assertEqual(self.heap.left_child(0), 1)
